...
mplot <- j_1870 %>% ggplot(aes(x = value_farms, y = perc_school)) + 
  ...
  theme_classic() + 
  labs(title = "Relationship Between Farm Value and Education, by County", subtitle = "Great Plains Region, United States, 1870", x = "Total Dollar Value of Farms", y = "Percent Students Ages 5-24 Enrolled in School")
